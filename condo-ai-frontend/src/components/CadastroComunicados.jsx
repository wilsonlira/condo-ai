...
const CadastroComunicados = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setConteudo("");
      setCondominioId("");
      setMensagem("✅ Comunicado cadastrado com sucesso!");
    } catch (erro) {
      console.error("Erro ao cadastrar comunicado:", erro);
      setMensagem("❌ Erro ao cadastrar comunicado. Verifique os dados e tente novamente.");
    } finally {
      setCarregando(false);
    }
  };
